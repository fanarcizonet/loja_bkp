...
$this->form_validation->set_rules('sistema_ie','Inscrição Estadual','trim|required|min_length[5]|max_length[30]');
$this->form_validation->set_rules('sistema_telefone_fixo','Telefone Fixo','trim|required|exact_length[14]');
$this->form_validation->set_rules('sistema_telefone_movel','Celular','trim|required|exact_length[15]');
...
$this->form_validation->set_rules('sistema_site_url','Endereço do Site','trim|required|min_length[5]|max_length[100]');
$this->form_validation->set_rules('sistema_email','E-mail','trim|required|min_length[5]|max_length[50]');
